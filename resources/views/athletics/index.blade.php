...
@section('title', 'Athletics — Plural Studio')
...
@endif
    ...
    <section style="position:relative; width:100%; height:100vh; overflow:hidden; background:#0d0a08;">
        ...
        <div style="position:absolute; top:2.5rem; left:2.5rem; z-index:10; color:#fff;">
            <h2 style="font-family:'DM Sans',sans-serif; font-size:2rem; text-transform:uppercase; font-weight:300; letter-spacing:0.03em;">Athletic</h2>
