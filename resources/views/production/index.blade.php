...
@section('content')
    ...
    <section style="position:relative; width:100%; height:100vh; overflow:hidden; background:#0d0a08;">
        ...
        <div style="position:absolute; bottom:2.5rem; left:2.5rem; color:#fff; max-width:520px;">
            <h1 style="font-family:'DM Sans',sans-serif; font-size:2rem; font-weight:300; letter-spacing:0.05em; margin-bottom:0.5rem; text-transform:uppercase;">
                Plural Production
            </h1>
            <p style="font-size:0.65rem; line-height:1.85; opacity:0.75; letter-spacing:0.03em;">
                Turning bold vision into cinematic reality, one frame at a time.
            </p>
        </div>
    </section>
